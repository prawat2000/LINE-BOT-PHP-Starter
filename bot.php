		...
		*/
		...
		if ($event['type'] == 'message' && $event['message']['type'] == 'text') {
			...
			if($rtext[0]=='สวัสดี'){
			   ...
			   $url="http://maemoh.egat.com/ais/webservice/PlotGraph.php?starttime=2016-10-14%2012:00:00&endtime=2016-10-14%2012:00:00&mmunit=".trim($rtext[1])."&point=d484&_unit=2";
			   $ch1 = curl_init();
                           ...
                           if(isset($obj[0]['d484'])){
                              $text = "กำลังผลิตของ UNIT ".$rtext[1]." ขณะนี้คือ ".$obj[0]['d484']." MW";
			   ...
			   $text = "นี่คือ Pw.bot หากท่านต้องการทราบ กำลังผลิต ให้พิมพ์ mw xx".$dt;
			}
